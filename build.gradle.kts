...
dependencies {
  ...
  implementation("info.jdavid.asynk:core:0.0.0.16.2")
...
bintray {
  ...
  pkg(delegateClosureOf<BintrayExtension.PackageConfig>{
    ...
    websiteUrl = "https://github.com/programingjd/asynk_http"
    issueTrackerUrl = "https://github.com/programingjd/asynk_http/issues"
    vcsUrl = "https://github.com/programingjd/asynk_http.git"
